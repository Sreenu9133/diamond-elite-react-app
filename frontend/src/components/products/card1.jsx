            ...
            <div className="card-detail rounded-lg p-5 bg-linear-to-r from-[#ffff] via-[#def3e9] to-[#c0ebda] shadow-2xl ">
                <span>
                    <span className="flex flex-col">
                        <p>Low-power cleaning vechile 03-B</p>
                        <p className="flex items-center"><LiaRupeeSignSolid /> 799</p>
                    </span>
                </span>
                ...
                <div className="inner-card p-2 my-2 rounded-[10px] flex flex-wrap bg-white shadwo-2xl border">
                    ...
                    <div className="container w-[45%] flex items-center gap-2">
                        ...
                        <span>
                            <p>Hourly Earnings</p>
                            <p className="flex items-center"><LiaRupeeSignSolid /> 0.7</p>
                        </span>
                    </div>
                    ...
                    <div className="container w-[45%]  flex items-center gap-2">
                        ...
                        <span>
                            <p>Daily rebate</p>
                            <p className="flex items-center"><LiaRupeeSignSolid /> 16.40</p>
                        </span>
                    </div>
                    ...
                    <div className="container w-[45%] flex items-center gap-2">
                        ...
                        <span>
                            <p>Reward Points</p>
                            <p className="flex items-center">80</p>
                        </span>
                    </div>
                    ...
                    <div className="container w-[45%] flex items-center gap-2">
                        ...
                        <span>
                            <p>Total Revenue</p>
                            <p className="flex items-center"><LiaRupeeSignSolid /> 16800</p>
                        </span>
                    </div>
