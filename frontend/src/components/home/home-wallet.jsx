...
function HomeWallet() {
    return (
        <div className="home-wallet w-full">
            <div className="wallet-card m-10 rounded-lg bg-white shadow-2xl p-7 flex flex-col gap-15">
                <div className="top-part flex items-center justify-between rounded-lg w-full">
                    ...
                    <span className="flex gap-2 w-[30%]">
                ...
                <div className="bottom-part flex w-full items-center justify-between">
                    <div className="card flex items-center gap-2 py-2 pl-4 w-[20%] rounded-lg bg-[#f0f1f2] shadow-xl">
