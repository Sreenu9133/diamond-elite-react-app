...
function StartMining(){
    return(
        <div className="start-mining-part py-10">
            ...
            <div className="mining-steps flex items-center justify-between w-full px-10 pt-7 flex-wrap max-[770px]:gap-5 max-[576px]:px-5">
                <div className="step1 flex flex-col items-center gap-2 w-[24%] p-2 rounded-lg relative bg-white shadow-2xl h-[40vh] max-[770px]:w-[48%] max-[770px]:gap-5 max-[616px]:h-[45vh] max-[576px]:w-full max-[576px]:h-50">
                    <h3 className="bg-[#d4af37] rounded-xl py px-2 -mt-5">01</h3>
                ...
                <div className="step1 flex flex-col items-center gap-2 w-[24%] p-2 rounded-lg relative bg-white shadow-2xl h-[40vh] max-[770px]:w-[48%] max-[770px]:gap-5 max-[616px]:h-[45vh] max-[576px]:w-full max-[576px]:h-50">
                    <h3 className="bg-[#d4af37] rounded-xl py px-2 -mt-5">02</h3>
                ...
                <div className="step1 flex flex-col items-center gap-2 w-[24%] p-2 rounded-lg relative bg-white shadow-2xl h-[40vh] max-[770px]:w-[48%] max-[770px]:gap-5 max-[616px]:h-[45vh] max-[576px]:w-full max-[576px]:h-50">
                    <h3 className="bg-[#d4af37] rounded-xl py px-2 -mt-5">03</h3>
                ...
                <div className="step1 flex flex-col items-center gap-2 w-[24%] p-2 rounded-lg relative bg-white shadow-2xl h-[40vh] max-[770px]:w-[48%] max-[770px]:gap-5 max-[616px]:h-[45vh] max-[576px]:w-full max-[576px]:h-50">
                    <h3 className="bg-[#d4af37] rounded-xl py px-2 -mt-5">04</h3>
